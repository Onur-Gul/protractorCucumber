...
exports.config = {
    ...
    //connection to selenium   ("./" -> this takes us one level up)
    seleniumServerJar: './jars/selenium-server-standalone-3.141.59.jar',
    //seleniumAddress: 'http://localhost:4444/wd/hub'  //(this is default address)
    //directConnect: true,
    
    //drivers:
    chromeDriver: './jars/chromedriver.exe',
    //geckoDriver: '',
    ...
    //for Parallel testing
        ...
        //shardTestFiles: false -> true specs will be shared by feature file (false: just 1)
        //maxImstance:1 -> number of browser instances running in parallel

    beforeLaunch: () => {
        /* A callback function called once configs are read but before any environment setup. 
        This will only run once before onPrepare to bring up test dependencies.
        */
    },
    onPrepare: () => {      
